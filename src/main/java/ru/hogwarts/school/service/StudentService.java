...
public class StudentService {
    ...
    @Transactional
    public StudentDto editStudent(long id, NewStudentDto student) {
        ...
        if (student.getFacultyId() != null) {
            ...
            faculty = facultyService.findFacultyById(student.getFacultyId());
        }
        Avatar avatar = null;
    ...
    public Collection<StudentDto> findStudentByAgeBetween(int from, int to) {
        ...
        return studentRepository
                .findByAgeBetween(from, to)
                .stream()
                .map(mapper::toDto)
                .toList();
    }

    public FacultyDto findFacultyByStudent(Long studentId) {
    ...
    @Transactional
    public StudentDto setStudentAvatar(long id, long avatarId) {
